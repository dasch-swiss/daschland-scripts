...
def make_root():
    ...
    root = excel2xml.make_root(shortcode="0011", default_ontology="daschland")
...
def _append_permissions(root_element: etree._Element) -> etree._Element:
    ...
    res_restricted.append(ALLOW("V", group="UnknownUser"))
    ...
    bitstream_prop_restricted.append(ALLOW("CR", group="Creator"))
