...
def _append_permissions(root_element: etree._Element) -> etree._Element:
    ...
    res_default = etree.Element("{%s}permissions" % xml_namespace_map[None], id="res-default")  # noqa: UP031
    ...
    res_restricted = etree.Element("{%s}permissions" % xml_namespace_map[None], id="res-restricted")  # noqa: UP031
